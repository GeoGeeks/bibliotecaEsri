...
var nombre;
var libros = [];
var table = document.getElementById("paraVenta");
...
for (var i = 0; i < libros.length; i++) {
    ...
    var venderBoton = document.createElement('a');
    venderBoton.setAttribute("onclick", "recopilarFormularioEnviar("+i+");");
    vender.appendChild(venderBoton);
    venderBoton.innerHTML = "Vender";
